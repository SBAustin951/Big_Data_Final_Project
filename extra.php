		...
		<div class="row">
			<div class="col-md-12" id="info">
				...
				<div class="tab-content">
					<div id="reviews" class="tab-pane fade in active" style="width: 600px; height: 550px">
            <?php
            $bid = $_GET['id'];
  					...
  					foreach($result as $r){
  						...
  						echo "<tr><th class='well' colspan='2'>".$r['stars']."</th></tr></thead>";
              echo "<tr><th class='well' colspan='2'>".$r['date']."</th></tr></thead>";
  						echo "<tbody><tr><td>".$r['text']."</td></tr></table></div>";
  					}
?>
          </div>
